...
# source:
# https://github.com/Liam0205/Tools/blob/master/Python/convert_chinese_digits_to_arabic.py

chs_arabic_map = {u'零':0, u'一':1, u'二':2, u'三':3, u'四':4,
        u'五':5, u'六':6, u'七':7, u'八':8, u'九':9,
        u'十':10, u'百':100, u'千':10 ** 3,
...
if __name__ == "__main__":
    ...
    print convertChineseDigitsToArabic ("一千一百三十八")
    print convertChineseDigitsToArabic ("１８５")
    print convertChineseDigitsToArabic ("338")
